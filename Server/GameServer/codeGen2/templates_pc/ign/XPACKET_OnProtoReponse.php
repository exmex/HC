...
require_once("XByteArray.php");
	...
	class XPACKET_OnProtoReponse
	{
		...
		public static function _ToBuffer($__dst/*XByteArray*/,$data/*:UCHAR[] */ )
		{
			...
			$__dst->writeInt32(XPACKET_OnProtoReponse::_Size($data/*:UCHAR[] */ ));
			$__xv +=4;
		...
		{
			return XPACKET_OnProtoReponse::_ToBuffer($__dst,$this->data );
		}
		
		public function Size()
		{
			return XPACKET_OnProtoReponse::_Size($this->data );
		}
