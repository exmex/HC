...
class SysClientPatchLogTemp {
	...
	public static function  loadedTable( $fields=NULL,$condition=NULL)
	{
		...
		if (empty($condition))
		{
			$sql = "SELECT {$p} FROM `client_patch_log_temp`";
		}
		else
		{			
			$sql = "SELECT {$p} FROM `client_patch_log_temp` WHERE ".SQLUtil::parseCondition($condition);
		}			
	...
	public static function insertSqlHeader($fields=NULL)
	{
		...
		if(!empty($fields)){
			...
			$result[0] = "INSERT INTO `client_patch_log_temp` ({$where}) VALUES ";	
			$ar = array();
			...
			$result[0]="INSERT INTO `client_patch_log_temp` (`id`,`version`,`filename`,`hash`,`update_time`,`svn_version`,`active`,`binary_version`,`raw_filename`,`size`) VALUES ";
	...
	public function  loaded( $fields=NULL,$condition=NULL)
	{
		...
		$sql = "SELECT {$p} FROM `client_patch_log_temp` WHERE {$where}";
	...
	public static function sql_delete($condition=NULL)
	{
		...
		$sql = "DELETE FROM `client_patch_log_temp` WHERE ".SQLUtil::parseCondition($condition);
	...
	public function  delete()
	{
		...
		$sql = "DELETE FROM `client_patch_log_temp` WHERE `id`='{$this->id}'";
	...
	private function  getInSQL()
	{
		...
		$sql = "INSERT INTO `client_patch_log_temp` ".$fields.$values;
	...
	private function  getUpSQL($condition)
	{
		...
		$sql = "UPDATE `client_patch_log_temp` SET {$update} WHERE {$condition}";
	...
	{				
		...
		$sql = "UPDATE `client_patch_log_temp` SET {$update} WHERE {$uc}";
