...
class SysContinuPay {
	...
	private $date_status_field = false;
	...
	public static function  loadedTable( $fields=NULL,$condition=NULL)
	{
		...
		if (empty($condition))
		{
			$sql = "SELECT {$p} FROM `continu_pay`";
		}
		else
		{			
			$sql = "SELECT {$p} FROM `continu_pay` WHERE ".SQLUtil::parseCondition($condition);
		}			
		...
		foreach($ar as $row)
		{
			...
			if (isset($row['date'])) $tb->date = intval($row['date']);
	...
	public static function insertSqlHeader($fields=NULL)
	{
		...
		if(!empty($fields)){
			...
			$result[0] = "INSERT INTO `continu_pay` ({$where}) VALUES ";	
			$ar = array();
			...
			$result[0]="INSERT INTO `continu_pay` (`id`,`user_id`,`version`,`date`) VALUES ";
			$result[1] = array('id'=>1,'user_id'=>1,'version'=>1,'date'=>1);
		}				
		return $result;
	}
	...
	public function  loaded( $fields=NULL,$condition=NULL)
	{
		...
		$sql = "SELECT {$p} FROM `continu_pay` WHERE {$where}";
		...
		if (isset($ar['date'])) $this->date = intval($ar['date']);
	...
	public static function sql_delete($condition=NULL)
	{
		...
		$sql = "DELETE FROM `continu_pay` WHERE ".SQLUtil::parseCondition($condition);
	...
	public function  delete()
	{
		...
		$sql = "DELETE FROM `continu_pay` WHERE `id`='{$this->id}'";
	...
	private function  getInSQL()
	{
		...
		$sql = "INSERT INTO `continu_pay` ".$fields.$values;
	...
	private function  getUpSQL($condition)
	{
		...
		$sql = "UPDATE `continu_pay` SET {$update} WHERE {$condition}";
	...
	{				
		...
		$sql = "UPDATE `continu_pay` SET {$update} WHERE {$uc}";
	...
	public function /*int*/ getDate()
	{
		return $this->date;
	}
	
	public function /*void*/ setDate(/*int*/ $date)
	{
		$this->date = intval($date);
		$this->date_status_field = true;		
		$this->this_table_status_field = true;		
	}

	public function /*void*/ setDateNull()
	{
		$this->date = null;
		$this->date_status_field = true;		
		$this->this_table_status_field = true;
