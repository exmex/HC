...
class SysPlayerGuildApplyInfo {
	...
	public static function  loadedTable( $fields=NULL,$condition=NULL)
	{
		...
		if (empty($condition))
		{
			$sql = "SELECT {$p} FROM `player_guild_apply_info`";
		}
		else
		{			
			$sql = "SELECT {$p} FROM `player_guild_apply_info` WHERE ".SQLUtil::parseCondition($condition);
		}			
		...
		foreach($ar as $row)
		{
			$tb = new SysPlayerGuildApplyInfo();			
	...
	public static function insertSqlHeader($fields=NULL)
	{
		...
		if(!empty($fields)){
			...
			$result[0] = "INSERT INTO `player_guild_apply_info` ({$where}) VALUES ";	
			$ar = array();
			...
			$result[0]="INSERT INTO `player_guild_apply_info` (`id`,`user_id`,`guild_id`,`apply_time`) VALUES ";
			$result[1] = array('id'=>1,'user_id'=>1,'guild_id'=>1,'apply_time'=>1);
		}				
		return $result;
	}
	...
	public function  loaded( $fields=NULL,$condition=NULL)
	{
		...
		$sql = "SELECT {$p} FROM `player_guild_apply_info` WHERE {$where}";
	...
	public static function sql_delete($condition=NULL)
	{
		...
		$sql = "DELETE FROM `player_guild_apply_info` WHERE ".SQLUtil::parseCondition($condition);
	...
	public function  delete()
	{
		...
		$sql = "DELETE FROM `player_guild_apply_info` WHERE `id`='{$this->id}'";
	...
	private function  getInSQL()
	{
		...
		$sql = "INSERT INTO `player_guild_apply_info` ".$fields.$values;
	...
	private function  getUpSQL($condition)
	{
		...
		$sql = "UPDATE `player_guild_apply_info` SET {$update} WHERE {$condition}";
	...
	{				
		...
		$sql = "UPDATE `player_guild_apply_info` SET {$update} WHERE {$uc}";
