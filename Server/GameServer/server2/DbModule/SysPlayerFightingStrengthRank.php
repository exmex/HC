...
class SysPlayerFightingStrengthRank {
	...
	public static function  loadedTable( $fields=NULL,$condition=NULL)
	{
		...
		if (empty($condition))
		{
			$sql = "SELECT {$p} FROM `player_fighting_strength_rank`";
		}
		else
		{			
			$sql = "SELECT {$p} FROM `player_fighting_strength_rank` WHERE ".SQLUtil::parseCondition($condition);
		}			
		...
		foreach($ar as $row)
		{
			$tb = new SysPlayerFightingStrengthRank();			
	...
	public static function insertSqlHeader($fields=NULL)
	{
		...
		if(!empty($fields)){
			...
			$result[0] = "INSERT INTO `player_fighting_strength_rank` ({$where}) VALUES ";	
			$ar = array();
			...
			$result[0]="INSERT INTO `player_fighting_strength_rank` (`user_id`,`server_id`,`gs`,`rank`,`last_rank`,`query_time`,`is_robot`) VALUES ";
	...
	public function  loaded( $fields=NULL,$condition=NULL)
	{
		...
		$sql = "SELECT {$p} FROM `player_fighting_strength_rank` WHERE {$where}";
	...
	public static function sql_delete($condition=NULL)
	{
		...
		$sql = "DELETE FROM `player_fighting_strength_rank` WHERE ".SQLUtil::parseCondition($condition);
	...
	public function  delete()
	{
		...
		$sql = "DELETE FROM `player_fighting_strength_rank` WHERE `user_id`='{$this->user_id}'";
	...
	private function  getInSQL()
	{
		...
		$sql = "INSERT INTO `player_fighting_strength_rank` ".$fields.$values;
	...
	private function  getUpSQL($condition)
	{
		...
		$sql = "UPDATE `player_fighting_strength_rank` SET {$update} WHERE {$condition}";
	...
	{				
		...
		$sql = "UPDATE `player_fighting_strength_rank` SET {$update} WHERE {$uc}";
