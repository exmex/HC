...
$testBeforeEncryption = "";
$testAfterEncryption = "";
$test = "";

$key = "123456789";

$crypt1 = new AESMcryptMgr();
$crypt1->setKey($key);
$test1 = $crypt1->encrypt($testBeforeEncryption);
echo "\nEncrypted=" . BytesToString ($test1, strlen($test1), " ") . "\n";

$crypt2 = new AESMcryptMgr();
$crypt2->setKey($key);
$test2 = $crypt2->decrypt($testAfterEncryption);
echo "\nDecrypted=" . BytesToString ($test2, strlen($test2), " ") . "\n";
