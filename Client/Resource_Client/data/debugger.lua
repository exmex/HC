...
local projectPath="/Users/eboz/Codes/hero/src/trunk/client/projects/hero/Resources";
local runtimePath="/Users/eboz/Library/Developer/Xcode/DerivedData/hero[\\-]giscbisdrmefkaboxosxdwzqvpbl/Build/Products/Debug/hero.app/Contents/Resources";

local blockingtcp = {}
do
   -- local socketcore = require"socket.core"
    local reg = debug.getregistry()
    blockingtcp.sleep      = socket.sleep
...
if LegendPlatformFLAG==ed.PlatformCode.CC_PLATFORM_IOS then 
  base_dir = LegendGetResourcePath();
  runtimePath = string.gsub(base_dir,"[\\-]", "[\\-]");
  print(base_dir);
  print(runtimePath);
...
do
    ...
    get_uri = function (source)
      -- search in cache
       source = source:gsub(runtimePath,projectPath)
...
commands = {
    ...
    breakpoint_set = function(self, args, data)
       ...
       --print("set breakpoint at ".. filename .. " line:".. lineno)
