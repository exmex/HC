...
local function create(param)
  param = param or {}
  local self = base.create("scrolldialog")
  setmetatable(self, class.mt)
  self.param = param
  local container
  container, self.ui = ed.editorui(ed.uieditor.scrolldialog)
...
class.create = create
local pop = function(param)
  local window = ed.ui.scrolldialog.create(param)
  window:popWindow(1000)
end
class.pop = pop
ed.popScrollDialog = pop
