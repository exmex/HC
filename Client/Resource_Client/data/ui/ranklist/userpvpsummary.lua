...
local function create(data)
  ...
  ui.gsTitle = ed.createNode({
    t = "Label",
    base = {
      text = T(LSTR("USERPVPSUMMARY.ALLFIGHTVALUE")),
      size = 18
    },
    layout = {
      anchor = ccp(0, 0.5),
  ...
  ui.guild = ed.createNode({
    t = "Label",
    base = {
      text = summary._guild_name and summary._guild_name~="" and T(summary._guild_name) or T(LSTR("CRUSADE.NOT_IN_GUILDS")),
      size = 16
    },
    layout = {
      anchor = ccp(0, 0.5),
