...
void OpenSLEngine::setEffectLooping(unsigned int effectID, bool isLooping)
{
	 ...
	 * backtrace:
#00 pc 001e810a /data/app-lib/com.ucool.hero-1/libcocos2dlua.so (OpenSLEngine::setEffectLooping(unsigned int, bool)+17)
#01 pc 001e836f /data/app-lib/com.ucool.hero-1/libcocos2dlua.so (SimpleAudioEngineOpenSL::playEffect(char const*, bool)+78)
#02 pc 001e6b45 /data/app-lib/com.ucool.hero-1/libcocos2dlua.so (CocosDenshion::SimpleAudioEngine::playEffect(char const*, bool)+28)
