...
extern "C"
{
    ...
    void preloadBackgroundMusicJNI(const char *path)
    {
		...
		//CCFileUtils *pFileUtils = new CCFileUtils();
		        
		jstring stringArg = methodInfo.env->NewStringUTF(cocos2d::CCFileUtils::sharedFileUtils()->fullPathForAudioFile(path).c_str());
