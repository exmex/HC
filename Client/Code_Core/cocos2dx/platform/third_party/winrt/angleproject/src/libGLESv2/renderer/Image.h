...
class Image
{
  public:
    ...
    virtual bool updateSurface(TextureStorageInterface2D *storage, int level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, bool mipped = true) = 0;
    ...
    static void loadBGRADataToBGRA(GLsizei width, GLsizei height,
                                   int inputPitch, const void *input, size_t outputPitch, void *output);
	//yinlong added 2014/5/9
	static void loadRGBA4444DataToBGRA4444(GLsizei width, GLsizei height,
										int inputPitch, const void *input, size_t outputPitch, void *output);
