                       ...
                       GLint unpackAlignment, const void *input)
{
    ...
    switch (mInternalFormat)
    {
      case GL_ALPHA8_EXT:
        ...
        break;
      case GL_LUMINANCE8_EXT://fix by yinlong 2014/5/9 , LUMINANCE8 Convert to DXGI_FORMAT_R8G8B8A8_UNORM waste to much memory
        loadLuminanceDataToNativeOrBGRA(width, height, inputPitch, input, mappedImage.RowPitch, offsetMappedData, true);
        break;
      ...
      case GL_RGBA8_OES:
        ...
        break;
      case GL_RGBA4:
		loadRGBA4444DataToBGRA4444(width, height, inputPitch, input, mappedImage.RowPitch, offsetMappedData);
        break;
      case GL_RGB5_A1:
