...
public interface IDownloaderClient {
    ...
    static final int STATE_PAUSED_ROAMING = 10;
    
    /**
     * Scary case.  We were on a network that redirected us to another website
     * that delivered us the wrong file.
     */
    static final int STATE_PAUSED_NETWORK_SETUP_FAILURE = 11;

    static final int STATE_PAUSED_SDCARD_UNAVAILABLE = 12;

    static final int STATE_FAILED_UNLICENSED = 13;
    static final int STATE_FAILED_FETCHING_URL = 14;
    static final int STATE_FAILED_SDCARD_FULL = 15;
    static final int STATE_FAILED_CANCELED = 16;

    static final int STATE_FAILED = 17;
