...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    // Listener
    Cocos2dxHelperListener mListener = null;
    ...
    public GoogleApiClient.Builder createApiClientBuilder() {
        ...
        builder.setViewForPopups(mActivity.getCurrentFocus());
     ...
     */
    public void setup(Cocos2dxHelperListener listener) {
        if (mSetupDone) {
    ...
    public void onStart(Activity act) {
        ...
        if (mConnectOnStart) {
            ...
            Cocos2dxHelper.handler().postDelayed(new Runnable() {
                @Override
                public void run() {
...
//        mActivity = null;
    ...
    public String getPlayerID() {
    	if (playerID.equals("")) {
    		...
    		if (!playerID.equals("")) {
    			LoginDataStorage.googlePlayID = playerID;
    		}
    	}
        Log.i("Google Play", "Player ID:" + LoginDataStorage.googlePlayID);
        return playerID;
    }
