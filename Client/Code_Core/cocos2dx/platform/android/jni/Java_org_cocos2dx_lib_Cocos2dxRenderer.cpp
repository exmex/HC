...
extern "C" {
    JNIEXPORT void JNICALL Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeRender(JNIEnv* env) {
        ...
        if (cocos2d::CCApplication::sharedApplication()->isRestarting() && !cocos2d::CCDirector::isCreate())
		{
			cocos2d::CCApplication::sharedApplication()->restartDone();
			if (!cocos2d::CCApplication::sharedApplication()->applicationDidFinishLaunching())
			{
				CCLog("Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeRender restarting failed");
				return ;
			}
		}
    }
