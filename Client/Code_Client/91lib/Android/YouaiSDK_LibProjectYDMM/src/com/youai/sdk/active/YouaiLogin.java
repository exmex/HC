		...
		registerBtn.setOnClickListener(new OnClickListener(){
			...
			public void onError(final YouaiException e) {
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						//Toast.makeText(YouaiLogin.this, "登录失败："+e.getMessage(), Toast.LENGTH_SHORT).show();
						progressbar.setVisibility(View.GONE);
					}
				});
			}
			 	...
			 	register.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(userName==null||userName.equals("")){
							Toast.makeText(YouaiLogin.this, "帐号不能为空", Toast.LENGTH_SHORT).show();
							return;
						}
						if(passWord==null||passWord.equals("")){
							Toast.makeText(YouaiLogin.this, "密码不能为空", Toast.LENGTH_SHORT).show();
							return;
						}
						if(!ToolsUtil.checkAccount(userName)){
							Toast.makeText(YouaiLogin.this, "帐号格式不正确", Toast.LENGTH_SHORT).show();
							return;
						}else if(!ToolsUtil.checkPassword(passWord)){
							Toast.makeText(YouaiLogin.this, "密码格式不正确", Toast.LENGTH_SHORT).show();
							return;
						}else if(userEmail!=null&&!userEmail.equals("")){
							if(!ToolsUtil.checkEmail(userEmail)){
							Toast.makeText(YouaiLogin.this, "邮箱格式不正确", Toast.LENGTH_SHORT).show();
							return;
							}
						}
						...
						YouaiApi.Register(md5sign, putmessage, new RequestListener() {
							...
							public void onIOException(IOException e) {
								...
								Toast.makeText(YouaiLogin.this, "注册失败", Toast.LENGTH_SHORT).show();
							}
								...
								try {
									...
									if(jsonback.getString("error").equals("200")){
										...
										runOnUiThread(new Runnable() {
											...
											register.setClickable(true);
											YouaiLogin.this.progressbar.setVisibility(View.INVISIBLE);
											Toast.makeText(YouaiLogin.this, "注册成功", Toast.LENGTH_SHORT).show();
										...
										runOnUiThread(new Runnable() {
											...
											public void run() {
												register.setClickable(true);
												YouaiLogin.this.progressbar.setVisibility(View.INVISIBLE);
												Toast.makeText(YouaiLogin.this, "注册失败："+errorMessage, Toast.LENGTH_SHORT).show();
											}
										});
									}
								} catch (Exception e1) {
					...
					public void onIOException(IOException e) {
						...
						runOnUiThread(new Runnable() {
							...
							public void run() {
								...
								Toast.makeText(YouaiLogin.this, "网络异常 登录失败", Toast.LENGTH_SHORT).show();		
							}
						});
					...
					public void onComplete(String response) {
						...
						try {
							...
							runOnUiThread(new Runnable() {
					            ...
					            textView.setText(YouaiCommplatform.getInstance().getLoginNickName()+"，欢迎您回来 ！");
								...
								runOnUiThread(new Runnable() {
									...
									public void run() {
										...
										Toast.makeText(YouaiLogin.this, "登录失败："+errorMessage, Toast.LENGTH_SHORT).show();
									}
								});
					...
					YouaiApi.TryToOk(message.toString(), new RequestListener() {
						...
						public void onIOException(IOException e) {
							...
							runOnUiThread(new Runnable() {
								...
								public void run() {
									loginingbar.setVisibility(View.GONE);
									Toast.makeText(YouaiLogin.this, "网络异常  注册失败", Toast.LENGTH_SHORT).show();		
								}
							});
				...
				YouaiApi.TryBinding(message.toString(), new RequestListener() {
					...
					public void onIOException(IOException e) {
						...
						runOnUiThread(new Runnable() {
							...
							public void run() {
								loginingbar.setVisibility(View.GONE);
								Toast.makeText(YouaiLogin.this, "网络异常 绑定失败", Toast.LENGTH_SHORT).show();		
							}
						});
					...
					public void onComplete(String response) {
						...
						try {
							...
							runOnUiThread(new Runnable() {
								...
								public void run() {
								loginingbar.setVisibility(View.GONE);
								Toast.makeText(YouaiLogin.this, "绑定成功："+backjsontosdk,Toast.LENGTH_SHORT).show();
								listener.onLoginSuccess(backjsontosdk);
								YouaiLogin.this.onBackPressed();
								}
								});
								...
								runOnUiThread(new Runnable() {
									...
									public void run() {
										loginingbar.setVisibility(View.GONE);
										listener.onLoginError(new YouaiError(errorMessage));
										Toast.makeText(YouaiLogin.this, "绑定失败："+errorMessage, Toast.LENGTH_SHORT).show();
									}
								});
		...
		YouaiApi.thirdLogin(message, new RequestListener() {
			...
			public void onIOException(IOException e) {
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						loginingbar.setVisibility(View.GONE);
						Toast.makeText(YouaiLogin.this, "登录失败", Toast.LENGTH_SHORT).show();		
					}
				});
