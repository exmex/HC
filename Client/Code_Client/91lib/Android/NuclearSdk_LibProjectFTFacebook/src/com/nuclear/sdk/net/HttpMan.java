...
public class HttpMan {
	...
	public String requestMan(String urlStr,String method, String param)throws SdkException {
	...
	public String  requestHttp(String urlStr,String method, String param)throws SdkException {
		...
		if (statusCode != 200) {
			...
			throw new SdkException(response, statusCode);
		}
		response = readHttpResponse(httpResponse);
		return response;
