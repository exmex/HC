...
//	private static final String BOUNDARY = "7cd4a6d158c";
	...
	/**
	 */
	public static String openUrl(String url, String method, HttpParameters params) throws SdkException {
		String result = "";
		try {
			...
			if (statusCode != 200) {
				...
				throw new SdkException(result, statusCode);
			}
			result = readHttpResponse(response);
			return result;
		} catch (IOException e) {
...
//			}
	...
	private static void imageContentToUpload(OutputStream out, String imgpath) throws SdkException {
		if(imgpath==null){
		    return;
		}
