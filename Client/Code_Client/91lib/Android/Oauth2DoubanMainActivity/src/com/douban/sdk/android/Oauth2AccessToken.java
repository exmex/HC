...
public class Oauth2AccessToken {
	...
	private String mdouban_user_id = "";
...
//	protected SecretKeySpec mSecretKeySpec;
		...
		if (responsetext != null) {
			if (responsetext.indexOf("{") >= 0) {
				try {
					...
					setMdouban_user_id(json.optString("douban_user_id"));
	...
	public String getMdouban_user_id() {
		return mdouban_user_id;
	}
	public void setMdouban_user_id(String mdouban_user_id) {
		this.mdouban_user_id = mdouban_user_id;
	}
