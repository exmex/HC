...
//	private static final String BOUNDARY = "7cd4a6d158c";
	 ...
	 */
	public static String openUrl(String url, String method, DoubanParameters params, String file) throws DoubanException {
		String result = "";
		try {
			...
			if (statusCode != 200) {
				...
				throw new DoubanException(result, statusCode);
			}
			result = readHttpResponse(response);
			return result;
		} catch (IOException e) {
...
//			}
	...
	private static void paramToUpload(OutputStream baos, DoubanParameters params)
			throws DoubanException {
		String key = "";
	...
	private static void imageContentToUpload(OutputStream out, String imgpath) throws DoubanException {
		if(imgpath==null){
		    return;
		}
