...
//	private static final String BOUNDARY = "7cd4a6d158c";
	 ...
	 */
	public static String openUrl(String url, String method, TaobaoParameters params, String file) throws TaobaoException {
		String result = "";
		try {
			...
			if (statusCode != 200) {
				...
				throw new TaobaoException(result, statusCode);
			}
			result = readHttpResponse(response);
			return result;
		} catch (IOException e) {
...
//			}
	...
	private static void paramToUpload(OutputStream baos, TaobaoParameters params)
			throws TaobaoException {
		String key = "";
	...
	private static void imageContentToUpload(OutputStream out, String imgpath) throws TaobaoException {
		if(imgpath==null){
		    return;
		}
