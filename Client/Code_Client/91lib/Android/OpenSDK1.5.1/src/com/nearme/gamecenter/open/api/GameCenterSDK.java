...
public class GameCenterSDK {
	 ...
	 * @param callback
	 */
	public void doGetUserNDou(final ApiCallback callback) {
		GCInternal.getInstance().doGetNDou(callback);
	}
	 ...
	 *            回调对象
	 */
	public void doPaymentForNBAO(final ApiCallback callback, final ProductInfo proInfo) {
		GCInternal.getInstance().doNewPaymentForNBAO(callback, proInfo);
	}
	
	public void doPaymentForNDou(final ApiCallback callback, final NDouProductInfo productInfo) {
		GCInternal.getInstance().doPaymentForNDOU(callback, productInfo);
	}
	 ...
	 * 
	 */
	public void doChargeForRMB(final ApiCallback callback, final ProductInfo proInfo) {
