...
public class GameCenterSDK {
	...
	public void doShowKebiCharge(final ApiCallback callback, final Activity activity) {
	...
	public void doShowGameCenter(final ApiCallback callback,final Activity activity) {
		GCInternal.getInstance().doShowGameCenter(callback,activity);
	}

	
	public void doShowSprite(final ApiCallback callback,final Activity activity) {
		GCInternal.getInstance().doShowSprite(callback,activity);
	}
