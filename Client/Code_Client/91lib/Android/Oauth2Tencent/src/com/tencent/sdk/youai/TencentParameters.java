...
/**
 * 在发起网络请求时，用来存放请求参数的容器�? * @author luopeng (luopeng@staff.sina.com.cn)
 */
public class TencentParameters {

	private ArrayList<String> mKeys = new ArrayList<String>();
	private ArrayList<String> mValues=new ArrayList<String>();
	
	
	public TencentParameters(){
	...
	public void addAll(TencentParameters parameters){
