...
//	private static final String BOUNDARY = "7cd4a6d158c";
	...
	/**
	 * 
	 * @param url 服务器地�?	 * @param method "GET"or “POST�?	 * @param params   存放参数的容�?	 * @param file 文件路径，如�?是发送带有照片的微博的话，此参数为图片在sdcard里的绝对路径
	 * @return 响应结果
	 * @throws TencentException
	 */
	public static String openUrl(String url, String method, TencentParameters params, String file) throws TencentException {
		String result = "";
		try {
			...
			if (statusCode != 200) {
				...
				throw new TencentException(result, statusCode);
			}
			result = readHttpResponse(response);
			return result;
		} catch (IOException e) {
...
//				// 获取当前正在使用的APN接入�?//				HttpHost proxy = NetStateManager.getAPN();
//				if (null != proxy) {
...
//			}
	...
	private static void paramToUpload(OutputStream baos, TencentParameters params)
			throws TencentException {
		String key = "";
	...
	private static void imageContentToUpload(OutputStream out, String imgpath) throws TencentException {
		if(imgpath==null){
		    return;
		}
