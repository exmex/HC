...
import com.youai.sdk.active.YouaiLogin.MyOAuthListener;
...
public class YouaiCommplatform {
	...
	public void facebookLogin(String uid,String token,Activity pAcitivity) throws JSONException{
		...
		YouaiApi.thirdLogin(message, new RequestListener() {
			...
			public void onComplete(String response) {
				...
				try {
					jsonback  = new JSONObject(response);
					error = jsonback.getString("error");
					if(error.equals(YouaiConfig.statuCode)){
					...
					pActivity.runOnUiThread(new Runnable() {
			            ...
			            View view = inflater.inflate(R.layout.toast, (ViewGroup)pActivity.findViewById(R.id.toast_layout_root));
