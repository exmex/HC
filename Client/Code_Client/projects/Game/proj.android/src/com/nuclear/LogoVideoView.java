...
public class LogoVideoView extends SurfaceView implements MediaPlayerControl,Callback {
	...
	public LogoVideoView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		mContext = context;
		initVideoView();
	}

	public LogoVideoView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		 ...
		 *		 else { //Log.i("@@@","aspect ratio is correct: " + //width+"/"+height+"="+
		 * //mVideoWidth+"/"+mVideoHeight); } }
		 
		 Log.i("@@@@@@@@@@111", "setting size: " + width + 'x' + height);
		 Log.i("@@@@@@@@@@222", "setting size: " + mVideoWidth + 'x' + mVideoHeight);
		 Log.i("@@@@@@@@@@333", "setting size: " +  mVideoWidth * height + 'x' + width * mVideoHeight);
