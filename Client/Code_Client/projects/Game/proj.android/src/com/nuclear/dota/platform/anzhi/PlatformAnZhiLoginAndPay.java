...
public class PlatformAnZhiLoginAndPay implements IPlatformLoginAndPay {
	...
	public void unInit() {
		...
		center.dismissFloaticon();
//		center.logout(game_ctx);
	}
	 ...
	 Handler mHandler = new Handler() {
	        ...
	        public void handleMessage(Message msg) {
	            ...
	            case 0:
	                ...
	                break;
	            case 1:
	                Toast.makeText(PlatformAnZhiLoginAndPay.getInstance().game_ctx, (String) msg.obj, Toast.LENGTH_SHORT).show();
	                break;
	            case 2:
	                center.login(game_ctx, true);
	                break;
	            }
	        }
	    };
					 ...
					 try {
		                ...
		                else if("key_pay".equals(key))
		                {
	                        ...
	                        if (code == 200) {
	                            ...
	                            {
	                            	PlatformAnZhiLoginAndPay.getInstance().pay_info = new PayInfo();
	                            }
	...
	OfficialLoginCallback mOfficialCall = new OfficialLoginCallback() {
		...
		@Override
		public String login(String user, String password, String deviceid,
				String key) {
			// TODO Auto-generated method stub
            try {
                Thread.sleep(2000);
