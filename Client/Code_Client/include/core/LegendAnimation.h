...
#ifndef __HelloLua__LegendAnimation__
#define __HelloLua__LegendAnimation__
...
class LegendAnimation : public CCSprite, public GameAnimation
{
public:
	...
	std::string getAniFileName();

protected:
	std::string mAniFileName;
	LegendAnimationFileInfo *         _aniFileInfo;  //+0x1C0 0xE0 * 2
    ...
    LegendAnimationAction *   _currentAction; //+0x1d4 0xea << 1
...
#endif /* defined(__HelloLua__LegendAnimation__) */
